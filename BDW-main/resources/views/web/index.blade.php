...
<section id="services" class="services">
      ...
      <div class="col-md-6 border-right">
        <div class="bg-white p-3">
          <h2 class="fw-bold text-capitalize text-center">
            {{ DbCache::setting('home_service_title') }}
          </h2>
        </div>
      </div>
      <div class="col-md-6">
        <div class="bg-white p-4 text-center">
          <p class="fw-light">
            {{ DbCache::setting('home_service_desc') }}
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    @foreach(DbCache::services() as $index => $service)
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 order-2 @if($index % 2 == 0) order-md-1 @endif">
          <div class="services__content">
            <div class="icon d-block {{ $service['icon'] }} fs-4rem mb-4"></div>
            <h3 class="display-3--title mt-1">{{ $service['title'] }}</h3>
            <p class="lh-lg">
              {{ $service['desc'] }}
            </p>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start order-1 @if($index % 2 == 0) order-md-2 text-end @endif">
...
@section('scripts')
  <script src="index/assets/vendors/js/glightbox.min.js"></script>
